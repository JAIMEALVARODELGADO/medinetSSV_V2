...
if(!empty($condicion)){
    ...
    if($consulta->num_rows<>0){
        ...
        while($row=$consulta->fetch_array()){
            ...
            echo "<td width='5%'><a href='#' onclick=paciente($row[id_persona],$row[identificacion]) title='Información del Paciente' class='btnhref'><span class='icon-v-card'></span></a></td>"; 
