...
<html lang="es-ES" dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script language="JavaScript">
        function consulta(id_,id_formato){
            url_="mn_nutricional11.php?id_ingreso="+id_;
            //alert(url_);
...
require("mn_menu_nutricional.php");
?>
...
//echo "<br>".$consulta;
    ...
    if($consulta->num_rows<>0){
        ...
        while($row=$consulta->fetch_array()){
            echo "<tr>";
            echo "<td width='5%'><a href='#' onclick=consulta($row[id_ingreso]) title='Registrar Atencion de Nutricion' class='btnhref'><span class='icon-calendar'></span></a></td>";        
