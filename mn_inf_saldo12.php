...
while($row=$consulta->fetch_array(MYSQLI_ASSOC)){
    ...
    <tr>
      ...
      <td align="right"><?php echo $row['cantidad_ingresa'];?></td>
      <td align="right"><?php echo $row['cantidad_aplicada'];?></td>
...
function encabezado(){
  ?>
  <img src="icons/encabezado_saldomedicamento.png" width="100%" height="80">
  <br>
  <?php
}
?>
