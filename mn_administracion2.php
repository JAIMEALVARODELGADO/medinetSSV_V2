...
<html lang="es-ES" dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script language="JavaScript">
        ...
        function editar(id_){
            window.open("mn_administracion21.php?id_movimiento="+id_,"_self");
        }
    </script>
...
<?php
$condicion="estado='AC' AND tipo_mov='A' AND ";
...
if(!empty($fecha_mov)){$condicion=$condicion."fecha_mov BETWEEN '$fecha_mov 00:00' AND '$fecha_mov 23:59' AND ";}
