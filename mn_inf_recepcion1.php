...
<html lang="es-ES" dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script language="JavaScript">
        function validar(){
            document.form1.action='mn_inf_recepcion1.php';
            document.form1.target='_self';
            document.form1.submit();
        }
        function imprimir(){
            //document.form1.action='mn_inf_recepcion11.php';
            document.form1.action='mn_inf_recepcion12.php';
...
?>
<div class="caja1">
    <h4>Informe de Recepci�n de Medicamentos y Dispositivos</h4>
</div>
